...
public class MainActivity extends AppCompatActivity {
    ...
    public void loadWeatherData(){
        NetworkTask nt=new NetworkTask(SunshinePreferences.getPreferredWeatherLocation(this));
        nt.execute();
    ...
    class NetworkTask extends AsyncTask<URL, Void, String[]> {
        ...
        protected String[] doInBackground(URL... params) {
            ...
            try {
                ...
                String temp = NetworkUtils.getResponseFromHttpUrl(url);
                result = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(MainActivity.this, temp);
            }
            catch (Exception e){
                e.printStackTrace();
            }
